...
const dfltBreatheHold: BreatheHold[] = [
  { breatheSec: 120, holdSec: 30, isActive: Activity.None },
  { breatheSec: 120, holdSec: 38, isActive: Activity.None },
  { breatheSec: 120, holdSec: 45, isActive: Activity.None },
  { breatheSec: 120, holdSec: 53, isActive: Activity.None },
  { breatheSec: 120, holdSec: 60, isActive: Activity.None },
  { breatheSec: 120, holdSec: 68, isActive: Activity.None },
  { breatheSec: 120, holdSec: 75, isActive: Activity.None },
  { breatheSec: 120, holdSec: 75, isActive: Activity.None },
];

@Component({
  selector: 'app-o2-deprivation',
  templateUrl: './o2-deprivation.component.html',
  styleUrls: ['./o2-deprivation.component.scss']
})
export class O2DeprivationComponent {
